...
liturgy_data = [
    ...
    (
        ...
        "Отче наш, Иже еси на небесех! Да святится имя Твое, да приидет Царствие Твое, да будет воля Твоя, яко на небеси и на земли. Хлеб наш насущный даждь нам днесь; и остави нам долги наша, якоже и мы оставляем должником нашим; и не введи нас во искушение, но избави нас от лукаваго. [Иерей:] Яко Твое есть Царство, и сила, и слава, Отца, и Сына, и Святаго Духа, ныне и присно, и во веки веков. [Лик:] Аминь.",
        "Vater unser im Himmel, geheiligt werde Dein Name. Dein Reich komme. Dein Wille geschehe, wie im Himmel, so auf Erden. Unser tägliches Brot gib uns heute. Und vergib uns unsere Schuld, wie auch wir vergeben unseren Schuldigern. Und führe uns nicht in Versuchung, sondern erlöse uns von dem Bösen. [Priester:] Denn Dein ist das Reich und die Kraft und die Herrlichkeit, des Vaters und des Sohnes und des Heiligen Geistes, jetzt und immerdar und in die Ewigkeiten der Ewigkeiten. [Chor:] Amen."
    ),
    ...
    (
        ...
        "Die Engelsmächte waren an Deinem Grabe, und die Wächter erstarrten wie Tote; und Maria stand am Grabe und suchte Deinen allreinen Leib. Du hast die Hölle gefangen genommen, ohne von ihr versucht zu werden; Du bist der Jungfrau begegnet und hast das Leben geschenkt. Der Du auferstanden bist von den Toten, Herr, Ehre sei Dir."
    ),
    (
        "oktoechos.tone_6.kontakion", "hymn",
        "Живоначальною дланию умершия от мрачных удоль воскресив всех Податель жизни Христос Бог, воскресение дарова человеческому роду: есть бо всех Спаситель, воскресение и живот, и Бог всех.",
        "Mit Deiner lebenspendenden Hand hast Du alle Toten aus den finsteren Tiefen auferweckt, Christus, unser Gott, der Lebensspender. Du hast dem Menschengeschlecht die Auferstehung geschenkt, denn Du bist der Retter aller, die Auferstehung, das Leben und der Gott von allen."
    ),
    (
...
def seed_database():
    ...
    # Recreate tables to ensure schema is initialized
    ...
    with Session(engine) as session:
        ...
        default_audios = [
            ("liturgy.opening_blessing", "System Default Speech - Segen"),
            ("liturgy.great_litany.lord_have_mercy", "System Default Speech - Ektenie"),
            ("liturgy.creed.main", "System Default Speech - Glaubensbekenntnis"),
            ("liturgy.lords_prayer.main", "System Default Speech - Vaterunser"),
        ]
